...
async function loadState(options = {}) {
    try {
        ...
        return {slides, menu_chums, keywords, messages, promo_code, promo_codes, category, product, page, menu_resources};
    } catch (err) {
...
const mapState = ({slides, messages, keywords, menu_chums, promo_code, promo_codes, category, product, page, menu_resources}) => {
    return {
