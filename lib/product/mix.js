...
router.get('/:productId(\\d+)', [deprecationNotice, getMix, sendLocalsResponse]);
router.get('/sage/:productId(\\d+)', [deprecationNotice, getSageBillDetail, sendLocalsResponse]);
