...
const debug = require('debug')('chums:lib:product:product');
...
async function load({id, keyword}) {
    try {
...
exports.getVariants = variant.getProductVariants;
exports.getMixItems = mix.getProductMix;
// exports.getItems = item.get;
// exports.getItemCodes = itemCodes.get;
// exports.getItemQty = itemQuantity.get;
exports.getImages = images.getImagesForProducts;
