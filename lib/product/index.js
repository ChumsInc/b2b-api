...
const debug = Debug('chums:lib:product');
...
router.get('/variants//product/:productID(\\d+)$', getVariantProduct);
router.delete('/variants/:id', validateUser, validateAdmin, delVariant);
router.post('/variants', validateUser, validateAdmin, postVariant);
