...
const v2 = require('./v2');
const {getProductItems, postProductItem, delProductItem} = require("./v2/item");
...
router.post('/items/:productId(\\d+)', postProductItem);
router.put('/items/:productId(\\d+)/:id(\\d+)', postProductItem);
router.delete('/items/:productId(\\d+)/:id(\\d+)', delProductItem);
