...
## [v1.6.2](https://github.com/ChumsInc/b2b-api/compare/v1.6.1...v1.6.2)

### Commits

- chore: update dependencies, bump ESLint and TypeScript versions, and cleanup unused packages in `package-lock.json` [`7b9ae43`](https://github.com/ChumsInc/b2b-api/commit/7b9ae43038306ad25d5e0d05876c3efd8473cf50)
- refactor: migrate from .pug to .ejs for template rendering [`7418c16`](https://github.com/ChumsInc/b2b-api/commit/7418c1622863583f5087b30ca82450d6d4a57463)
- chore: [`1475a4f`](https://github.com/ChumsInc/b2b-api/commit/1475a4f649a3fab63654ec1baae2692b02d5a7b3)
- chore: update dependencies, bump TypeScript, EJS, and ESLint versions, and adjust `package-lock.json` for compatibility [`a61559b`](https://github.com/ChumsInc/b2b-api/commit/a61559b5364ce78161c6d0d9fde27acc24b2c123)
- chore: [`aa55e53`](https://github.com/ChumsInc/b2b-api/commit/aa55e5344586b9f28c9f033e818d13bcb8a93462)
- chore: remove `lib/search/search-v2.js`, update `item-search.js` with stricter exclusions, and fix parameter handling in `getItemSearch` [`69c34bb`](https://github.com/ChumsInc/b2b-api/commit/69c34bbdb1d660a2fcf70b5c79d43fe85f856c04)
- chore: update dependencies, switch to `@tsconfig/node24`, optimize middleware order in `index.js`, and adjust .gitignore [`3568b09`](https://github.com/ChumsInc/b2b-api/commit/3568b097b332589c4cd2f6af34c4cf51124a4bde)
- npm updates [`8147a40`](https://github.com/ChumsInc/b2b-api/commit/8147a4059d182d7ca8ba72d7a2a2814b06a0ab14)
- chore: refactor error handling across category and image endpoints, simplify SQL query parameters, clean up unused `images.d.ts`, and add new `tsconfig.json` for TypeScript configuration [`15f1d28`](https://github.com/ChumsInc/b2b-api/commit/15f1d289baa5231dbdecfeebb1555d298f6a626c)
- chore: update dependencies in `package-lock.json`, upgrade `@typescript-eslint` to v8.52.0, `mysql2` to v3.16.0, `nodemailer` to v7.0.12, and other related packages [`446ce8e`](https://github.com/ChumsInc/b2b-api/commit/446ce8e4608e80c896697b2aa625986429844e6b)
- chore: add `getHolidays` endpoint, refactor holiday handling with `loadHolidays` method, and update `nextShipDate` logic to include dynamic holiday retrieval [`cc11961`](https://github.com/ChumsInc/b2b-api/commit/cc11961f385885e19bb48b57f0ec81ea48c20a69)
- chore: add script to clean up excessive cart history entries, optimize history validation, and remove redundant sync actions [`adee49d`](https://github.com/ChumsInc/b2b-api/commit/adee49d6488b206e01ddd1cc493e7c231a08d4c6)
- chore: remove legacy routes and deprecation notices, clean up unused imports, and optimize endpoint definitions in `index.js` and `index.ts` [`2170bd6`](https://github.com/ChumsInc/b2b-api/commit/2170bd6b1b22ef7a64726adc4adc66f7968b787c)
- chore: enhance SQL synchronization in cart methods, improve error handling with detailed responses, and update `shipExpireDate` logic in cart syncing and loading processes [`29206e3`](https://github.com/ChumsInc/b2b-api/commit/29206e3b46ded7f7856f29003b4b9a97dd3f29c1)
- chore: improve error handling in cart methods with consistent HTTP status codes, add debug logging for `createNewCart`, and refine parameter validations [`26bd32f`](https://github.com/ChumsInc/b2b-api/commit/26bd32fccb25c15c1dead28bcbe89f2758300d1c)
- chore: fix SQL query parameter handling for `ip` and `user_id`, add validation for error logging requests, and enhance error handling in `index.js` and `index.ts` [`9a277ec`](https://github.com/ChumsInc/b2b-api/commit/9a277ec487aa264f9fa3b01c95beb88070301923)
- chore: refactor `loadPage` to default `includeInactive` in API calls, update `redirectTo` initialization, and streamline parameter usage [`3a08f4f`](https://github.com/ChumsInc/b2b-api/commit/3a08f4fa90df36b4b504591f66fffd28ab1effd8)
- chore: add `maxCustomerKeyLength` validation in cart methods to enhance customerKey handling and improve error responses [`ad64efe`](https://github.com/ChumsInc/b2b-api/commit/ad64efe438377e5826d64342826b0a53847bf32b)
- chore: refine type handling in `sync-cart.ts` by adding explicit casts for `QueryValues` and `salesOrderNo` [`22218b4`](https://github.com/ChumsInc/b2b-api/commit/22218b48f046c4ccbbcd904493adb84e26478e6f)
- chore: add client IP to `aboutAPI` response in `index.js` and `index.ts` [`7fc8275`](https://github.com/ChumsInc/b2b-api/commit/7fc8275121cd221a261d0e7214ff614eeda95421)
- chore: add `/search/items.json` route in `index.ts` and `index.js` to handle `getItemSearch` logic [`3aade8d`](https://github.com/ChumsInc/b2b-api/commit/3aade8d70381cbd21910cce77c8b75029ffa3cb5)
- chore: stringify `componentStack` in error reporting methods in `index.js` and `index.ts` to ensure consistent serialization [`76bf93a`](https://github.com/ChumsInc/b2b-api/commit/76bf93a60437eeb7ad288152558720ac2c4115cb)
- chore: simplify `debug` property assignment in error reporting methods in `index.js` and `index.ts` [`66f960d`](https://github.com/ChumsInc/b2b-api/commit/66f960dde34de5028d2b5ec9124f0a2414822cab)
- chore:npm updates [`80bff58`](https://github.com/ChumsInc/b2b-api/commit/80bff589512af3122c9a7390abf13ba7fcd8524e)
- chore: fix SQL query parameter handling for `ip` and `user_id`, add validation for error logging requests, and enhance error handling in `index.js` and `index.ts` [`a0a2077`](https://github.com/ChumsInc/b2b-api/commit/a0a207773e05441bb68d2f14732244b6d7320f0c)
- chore: add condition to filter out items with zero quantity ordered in load-cart query [`4a49fe9`](https://github.com/ChumsInc/b2b-api/commit/4a49fe99c57407958236ac8ebcd8ff9861e379dd)

## [v1.6.1](https://github.com/ChumsInc/b2b-api/compare/v1.6.0...v1.6.1) - 2025-12-15

### Commits

- chore: update dependencies, add `express-rate-limit`, refactor SQL queries for case insensitivity, validate `customerKey` in cart methods, and optimize rate limiting in `index.js` [`0533ec5`](https://github.com/ChumsInc/b2b-api/commit/0533ec5c9f036c295f88be61c4e8b056525ba411)
- chore: remove `specials.js`, update `category.js` with SQL query adjustments, refactor search functions to simplify parameters, and upgrade `chums-types` to v3.5.0 [`a977b59`](https://github.com/ChumsInc/b2b-api/commit/a977b59dfe0b423f20808908c6c3ba327a7cb0f6)
- chore:npm udpates [`d0cead6`](https://github.com/ChumsInc/b2b-api/commit/d0cead6dfe95070bf8cea1e934c0a97dceb03607)

## [v1.6.0](https://github.com/ChumsInc/b2b-api/compare/v1.5.0...v1.6.0) - 2025-12-01

### Commits

- chore: update dependencies in `package-lock.json`, add `chums-types` package, and upgrade `@typescript-eslint` and related packages [`52693f1`](https://github.com/ChumsInc/b2b-api/commit/52693f1348d26a1106b263309508db4f3720fd85)
- features and fixes: [`a2d8db5`](https://github.com/ChumsInc/b2b-api/commit/a2d8db57fa673b6ae71f79f4c7ce7d446de14565)
- chore: migrate cart types to shared "chums-types/b2b" package and remove local type definitions [`a9f26e5`](https://github.com/ChumsInc/b2b-api/commit/a9f26e573cb71f4f53699ee498343cef17f6b1b8)
- chore: npm updates [`64f8d33`](https://github.com/ChumsInc/b2b-api/commit/64f8d33389c156eecf914c3c6c1ab9ea1a6820d2)
- chore: refactor and enhance product routes, add deprecation notices for legacy paths, update type imports to shared "chums-types/b2b" package, and incorporate new utility functions [`19b8d51`](https://github.com/ChumsInc/b2b-api/commit/19b8d510d3b61c6818af8c0ae8c7f1d101279ab2)
- chore: npm updates [`9390ee0`](https://github.com/ChumsInc/b2b-api/commit/9390ee0f8d4acdea66d949d3b4a75b0b25063e27)
- feat: introduce buildPreloadedStateV2a with enhanced banner state handling, refactor state structure and endpoints for state retrieval and rendering [`b3295e8`](https://github.com/ChumsInc/b2b-api/commit/b3295e8ca951fd695754feb452631bbcd28b88ea)
- updates to pages handling: enhanced admin checks, improved inactive content filtering, refactored routes and page queries [`a29bb70`](https://github.com/ChumsInc/b2b-api/commit/a29bb709708d35ceaba42ddc093897d107cf11a6)
- chore: add deprecation notices for legacy routes, introduce `.json` endpoint variants, clean up unused code, and enhance preloaded state handling with v2a integration [`dd93ead`](https://github.com/ChumsInc/b2b-api/commit/dd93eade65212a3b6b4d41b55477d0548a97bb85)
- chore: refactor site-messages module, update type imports to "chums-types/b2b", clean up interfaces, improve function definitions, and enhance error handling formatting [`99120cc`](https://github.com/ChumsInc/b2b-api/commit/99120ccb368940676fe1d8f6da95b7e87248ab15)
- feat: add buildPreloadedStateV2a with updated banner handling and new endpoints for state retrieval and rendering [`1878abe`](https://github.com/ChumsInc/b2b-api/commit/1878abecadcdcf202e21d138a499d9cea517a57a)
- chore: migrate product and related modules to shared "chums-types/b2b" package, refactor loadList function, and remove unused data fields [`8bf8630`](https://github.com/ChumsInc/b2b-api/commit/8bf86303c0e967db0daa5735e4b08946e88fc2df)

## [v1.5.0](https://github.com/ChumsInc/b2b-api/compare/v1.4.5...v1.5.0) - 2025-09-25
